...
try {
    ...
    gargallo = require('gargallo/index');
} finally {
    require = ace_require;
}
...
var validate = function(input) {
    ...
    var lexer = new gargallo.GargalloLexer(stream);
    var tokens = new antlr4.CommonTokenStream(lexer);
    var parser = new gargallo.GargalloParser(tokens);
    var annotations = [];
...
ace.define("ace/mode/gargallo_worker",["require","exports","module","ace/lib/oop","ace/worker/mirror"], function(require, exports, module) {
    "use strict";
